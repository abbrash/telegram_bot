...
async def wallets_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    text = """برای شرکت در ایردراپ‌های مختلف به کیف پول‌ غیرحضانتی (Non-Custodial Wallet) نیاز دارید. 
در این بخش آموزش ساخت و کار با تعدادی از کیف‌ پول‌های پرکاربرد آورده شده است.
